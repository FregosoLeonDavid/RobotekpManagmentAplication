...
import com.mycompany.viewsoperations.JPanelAddEnrollments;
import com.mycompany.viewsoperations.JPanelEditEnrollments;
 ...
 */
public class JPanelEnrollment extends javax.swing.JPanel {

    /**
     * Creates new form home
     */
    public JPanelEnrollment() {
        initComponents();
        InitStyles();
        InitTableComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("INSCRIPCIONES");
        ...
        jtStudents.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Alumno", "Curso", "Fecha de inicio", "Monto mensual", "Cantidad de meses", "Monto pagado", "Deuda"
            }
        ) {
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseClicked
        JPanelAddEnrollments ae = new JPanelAddEnrollments();
        DashboardMainJFrame.showContent(ae);
    }//GEN-LAST:event_btnAddMouseClicked

    private void btnEditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditMouseClicked
        JPanelEditEnrollments ae = new JPanelEditEnrollments();
        DashboardMainJFrame.showContent(ae);
